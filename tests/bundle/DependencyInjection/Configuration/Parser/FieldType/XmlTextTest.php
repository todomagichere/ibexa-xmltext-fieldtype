            ...
            [
                ...
                [
                    'fieldtypes.ezxml.custom_xsl' => [
                        ...
                        ['path' => '%kernel.project_dir%/vendor/netgen/ibexa-xmltext-fieldtype/lib/FieldType/XmlText/Input/Resources/stylesheets/eZXml2Html5_core.xsl', 'priority' => 0],
                        ['path' => '%kernel.project_dir%/vendor/netgen/ibexa-xmltext-fieldtype/lib/FieldType/XmlText/Input/Resources/stylesheets/eZXml2Html5_custom.xsl', 'priority' => 0],
                        ['path' => '/foo/bar.xsl', 'priority' => 123],
                        ['path' => '/foo/custom.xsl', 'priority' => -10],
                        ['path' => '/another/custom.xsl', 'priority' => 27],
                    ],
